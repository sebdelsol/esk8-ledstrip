...
* launch [debugLedstrip.py](https://github.com/sebdelsol/Esk8/blob/master/DebugLedstrip.py) - dependencies : [PyGame](https://www.pygame.org), [Websocket](https://pypi.org/project/websocket_client/) & [ZeroConf](https://pypi.org/project/zeroconf/) 
